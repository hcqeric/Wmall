    ...
    <mt-popup v-model="showAgreement" position="bottom" class="modal-popup-agreement"  >
      <div class="user-agreement">
        ...
        <article>
          ...
          <p>3、会员保证符合直销法律法规的规定及美健智韵对会员加入的要求，年满22周岁，并非无民事行为能力或者限制民事行为能力的人员、全日制在校学生、教师、医务人员、公务员、现役军人、直销企业的正式员工、境外人员及法律、行政法规规定不得从事兼职的其他人员；同时，申请成为会员应遵纪守法、无刑事故意犯罪记录，且不属于我国政府禁止的任何邪教和非法组织成员；违反《直销管理条例》中关于直销员身份的禁止性规定，即同时违反本条款的约定，该申请人签署的本协议自始无效，申请人不享有成为会员的任何合法权益。</p>
          ...
          <p>3、会员应在会员权益内遵守金士力公司相关业务及会员管理规定，会员在会员权益外的个人行为需遵守中华人民共和国各项法律法规。会员需理解并同意，美健智韵有权依合理判断对违反有关法律法规或本协议规定的行为进行处理，对违法违规的任何会员采取适当的法律行动，并依据法律法规保存有关信息向有关部门报告等，会员应承担由此而产生的一切法律责任，如由此给美健智韵造成损失，应承担赔偿责任。</p>
          ...
          <p>1、会员应严格遵守中华人民共和国法律、法规，履行《直销管理条例》、《禁止传销条例》、《经销商管理办法》及本协议全部规定的有关会员的所有义务。</p>
          ...
          <p>6、会员应保证只在本人所隶属分支机构所在的省（自治区、直辖市）已经设立服务网点的地区开展直销活动。</p>
          ...
          <p>(3)会员应努力学习产品知识，深刻了解产品功效；严格按照金士力提供的产品资料介绍推广产品。进行产品示范，不得对产品的用途、性能等进行夸大、失实或招人误解的虚假宣传，否则美健智韵将按照《经销商管理办法》有关规定进行处理，情节严重的，应承担所引发的法律责任；</p>
          ...
          <p>3、美健智韵允许会员在购买30日内退货，详见退货制度。超过30日后美健智韵无法认可退货请求具有合法性，且美健智韵须遵守向市场支付销售报酬周期（30日后）之约定。会员主张货款退回的最长周期仅为购货日后30日，且需要退回合乎美健智韵要求的产品。会员主张受他人蛊惑、误导而错过退货期限的，需向责任人问责。</p>
